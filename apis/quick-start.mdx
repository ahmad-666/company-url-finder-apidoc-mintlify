---
title: Quick Start
description: This guide will get you all set up and ready to use the Company URL Finder API. We'll cover how to get started using one of our API endpoints and how to make your first API request. We'll also look at where to go next to find all the information you need to take full advantage of our powerful REST API.
icon: user-check
---

<Tip>
  <p>
    Before you can make requests to the Company URL Finder API, you will need to grab your API key from your dashboard. You find it under 
    <a target="_blank" href="https://companyurlfinder.com/login">
      {" "}
      Account » API key.{" "}
    </a>
  </p>
